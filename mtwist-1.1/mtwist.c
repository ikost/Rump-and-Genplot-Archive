/** Modifications for Thompson
--  line 975 - added explicit typedef - randomunion.randomvalue = (uint32_t) (tb.time * 1000 + tb.millitm);
--  Commented out #include <inttypes.h> and added #define to modify the fscanf and fprintf commands using PRIu32 and SCNu32
**/ 
...
/* -- Modifications due to absence of inttypes.h in Microsoft C */
/* #include <inttypes.h> */
#define	NO_INTTYPES
