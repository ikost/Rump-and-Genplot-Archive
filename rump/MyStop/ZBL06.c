/* ===========================================================================
-- Ziegler SRIM 2006 stopping power module
--
-- This program returns stopping powers using SRIM's external module
-- capability.
--
-- SRIM Requirements:
--  (1) Must be installed in default location
--        c:\Program Files\srim 2006\SR Module
--
-- Requirements:
...
void msg(char *text) {
	...
	char log_path[]  = "c:/Program Files/SRIM 2006/SR Module/log.txt";
...
int ZStop(int z1, double m1, int z2, double m2, float kev[], float stop[], int npt) {

	double a1,a2,a3;
	int i, rcode;
	FILE *funit;
	char current_path[256];
	char srim_path[] = "c:/Program Files/SRIM 2006/SR Module";
	char data_path[] = "c:/Program Files/SRIM 2006/SR Module/rump.data";
	char aline[256], *aptr;
...
/* Create the data file */
	if ( (funit = fopen("SR.IN", "w")) == NULL) {
		fprintf(stderr, "Doesn't appear that SRIM 2006 is installed\n");
		return(-1);
	}
